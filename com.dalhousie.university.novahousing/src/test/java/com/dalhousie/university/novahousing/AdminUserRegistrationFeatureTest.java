...
@SpringBootTest
public class AdminUserRegistrationFeatureTest {

    AdminUser userRegistrationTestObject;
    ...
    @BeforeEach
    public void init() {
       userRegistrationTestObject =new AdminUser();
       ...
       userRegistrationTestObject.setRole(Role.ROLE_ADMIN);
